...
<!-- generic new service request make patient traced and remove listed ids add UPRN and address -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fhir="http://hl7.org/fhir" version="1.0">
	...
	<xsl:template match="fhir:Location/fhir:extension/fhir:extension[@url='eastings']"/>
	<xsl:template match="fhir:Location/fhir:extension/fhir:extension[@url='northings']"/>
