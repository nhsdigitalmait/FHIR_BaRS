...
<!-- sets the appointment status to cancelled and remove extra elements and changes details -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fhir="http://hl7.org/fhir" version="1.0">
	...
	<xsl:template match="fhir:Appointment/fhir:participant/fhir:actor/fhir:reference/@value">
		<xsl:attribute name="value">12345</xsl:attribute>
	</xsl:template>
