...
<!-- generic new service request make patient traced and remove listed ids add eastings/northings -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fhir="http://hl7.org/fhir" version="1.0">
	...
	<xsl:template match="fhir:extension[@url='https://fhir.nhs.uk/StructureDefinition/LocationExtension']/fhir:extension[@url='UPRN']"/>
